...
<div class="permission_denied">
  ...
  <div class="denied__wrapper">
    <h1 class="err-title"><?= Html::encode($this->title) ?></h1></br>
    <h3><?= Yii::$app->params['appName'] ?> Admin : Impostor detected !!!</br><?= nl2br(Html::encode($message)) ?></h3>
    ...
    <a href="/site/index"><button class="denied__link">Go Home</button></a>
  </div>
<!-- partial -->
  <script src='https://cdn.jsdelivr.net/particles.js/2.0.0/particles.min.js'></script>
  <script  type="text/javascript" src="/js/script.js" 0="yii\web\JqueryAsset"></script>
