...
<head>
    ...
    <?php $this->registerCssFile('/css/theme-dark.css?v=22'); ?>
    <?php $this->registerCssFile('/css/theme-light.css?v=22'); ?>
    <?php $this->head() ?>
</head>
        ...
        <?php
            ...
            echo Nav::widget([
                ...
                'items' => [
                    ...
                    ['label' => 'Agent', 'url' => ['/site/comment'], 'active' => Yii::$app->controller->id === 'site' && Yii::$app->controller->action->id === 'comment'],
